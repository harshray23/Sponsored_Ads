...
import { checkConnection, createRequest, acceptRequest, submitWork, approveWork, rejectWork, getRequest, listRequests } from "../lib/nero.js";
import "./App.css";
    ...
    return (
        <main className="app" ref={appRef}>
            ...
            <section className="hero">
                <p className="kicker">Nero Chain Project</p>
